...
namespace Flight_Booking_System.Controllers
{
    ...
    public class PassengerController : ControllerBase
    {
        ...
        public PassengerController(IPassengerRepository _passengerRepository, IMapper mapper, IFlightRepository flightRepository, BookingcketRepository ticketRepository)
        {
