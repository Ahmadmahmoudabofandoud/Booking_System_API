...
namespace Flight_Booking_System.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        private readonly BookingcketRepository _ticketRepository;
        ...
        public AccountController(UserManager<ApplicationUSer> userManager, IConfiguration configuration, IEmailService emailService,
             ...
             BookingcketRepository ticketRepository, IFlightRepository flightRepository, ISeatRepository seatRepository, IPhoneConfirmationService phoneConfirmationService)
        {
