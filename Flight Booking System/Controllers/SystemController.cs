...
namespace Flight_Booking_System.Controllers
{
    ...
    public class SystemController : ControllerBase
    {
        ...
        private readonly BookingcketRepository ticketRepository;
        ...
        public SystemController
         (IAirPortRepository airPortRepository, IFlightRepository flightRepository,
          ...
          ISeatRepository seatRepository , BookingcketRepository ticketRepository)
        {
        ...
        [HttpGet]
        public ActionResult<GeneralResponse> InBookingalize()
        {
            ...
            if (flights == null || flights.Count == 0)
            {
                ...
                {
                    IsSuccess = false,
                    Message = "There are no flights to inBookingalize"
                };
            }
            ...
            {
                IsSuccess = true,
                Message = "All Data Have been inBookingalized successfully :D"
            };
        }
    }
}